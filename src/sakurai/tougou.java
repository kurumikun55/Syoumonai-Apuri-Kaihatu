...
public class tougou {
    ...
    public static void main(String[] args) {
        ...
        button.addActionListener(e -> {
            ...
            Timer timer = new Timer(200, ev -> {int value = progressBar.getValue();
            if (value < 99) {
    ...
    private static void createSmallPopup() {
        ...
        small.add(new JLabel("予期せぬERRORが発生しました", SwingConstants.CENTER));
